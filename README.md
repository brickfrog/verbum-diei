...
- Hours of Prayer sourced via `breviarium` (Spanish source text; optional English translation at build time)
...
- Vatican News RSS for the daily reading references.
- `romcal` for liturgical calendar metadata.
- `breviarium` for Hours of Prayer source texts.
